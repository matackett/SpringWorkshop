...
Now in github.com, search for the repository here: https://github.com/matackett/SpringWorkshop
and havd it ready. It's okay to go ahead and double click on the md file called intro-r.md and follow along.  
...
```{r get your github congfigured, eval = F}
library(usethis)
